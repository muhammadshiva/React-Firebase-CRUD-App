  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id !== undefined && id !== "") {
        ...
        setMessage({ error: false, msg: "News added successfully!" });
      }
    } catch (err) {
    ...
    <>
      <div className="p-4 box">
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3" controlId="formNewsAuthor">
            <InputGroup>
              <InputGroup.Text id="formNewsAuthor">A</InputGroup.Text>
              <Form.Control
                type="text"
